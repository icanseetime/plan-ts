                            ...
                            <div className="gridBox">
                                <div className="dueslide">
                                    <div className="duedate">
                                        ...
                                        {waterDue >= 1 ? (
                                            <p className="watr"> Water the plant in <span>{waterDue}</span> day{waterDue !== 1 ? 's' : ''}! </p>
                                        ) : (
                                            <p className="watr"> Water the plant <span>today</span>! </p>
                                        )}
                                        {fertDue >= 1 ? (
                                            <p className="watr"> Fertilize the plant in <span>{fertDue}</span> day{fertDue !== 1 ? 's' : ''}! </p>
                                        ) : (
                                ...
                                <div className="imgLoc">
                                    ...
                                    <div className="location">
                                        <h2>Location</h2>
                                        <p>Building: {plant.location.building.name}</p>
                                        <p>Floor: {plant.location.floor}</p>
                                        <p>Room: {plant.location.room}</p>
                                    </div>
                                </div>
                            </div>
                            <Link className="viewbtn"
                                to={{ pathname: `/plants/${plant._id}`, state: {_id: plant._id} }}
                            >View plant</Link>
                        </div>
                    )
                })
